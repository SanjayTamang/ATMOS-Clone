...
export const Experience = () => {
    ...
    return [
      {
        ...
        title: "Welcome !!!",
        subtitle: `Wanna know about my details? Click Below :`,
        buttonLabel: "Resume | CV",
        buttonLink: ("./images/SanjayTamang_Resume.pdf"),
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: "Projects !!!",
        subtitle: `Wanna know about my work? Click Below :`,
        buttonLabel: "My Works",
        buttonLink: "https://sanjaytamang.com",
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        title: "Skills !!!",
        subtitle: `Wanna know about my skills? Click Below :`,
      ...
      },
      {
        ...
        title: "Contact !!!",
        subtitle: `Wanna know about my contacts? Click Below :`,
        buttonLabel: "Contact",
        buttonLink: "https://sanjaytamang.com",
      },
    ];
  ...
  useFrame((_state, delta) => {
    ...
    // Adjust camera properties based on aspect ratio
    if (aspectRatio > 1) {
      // LANDSCAPE
    ...
    let angleDegrees = (angle * 360) / Math.PI;
    ...
    // SET BACK ANGLE
    angle = (angleDegrees * Math.PI) / 360;
